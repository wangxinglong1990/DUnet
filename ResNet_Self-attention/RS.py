...
class ResBlock(nn.Module):
    def __init__(self,chanels):
        ...
        self.l1 = nn.Sequential(nn.Conv3d(chanels, chanels, kernel_size =(3,3,3), padding=(1,1,1)),nn.ReLU())
        self.l2 = nn.Sequential(nn.Conv3d(chanels, chanels, kernel_size =(3,3,3), padding=(1,1,1)),nn.ReLU())
    def forward(self,x):
        x1 = self.l1(x)
        x2 = self.l2(x1)
        out = x + x2
...
class RS(nn.Module):
    def __init__(self):
        ...
        self.res1_1 = ResBlock(36)
        self.res1_2 = ResBlock(36)
        self.res1_3 = ResBlock(36)
        self.double_conv2 = DoubleConvLayer(in_channels=36, out_channels=72)
        self.res2_1 = ResBlock(72)
        self.res2_2 = ResBlock(72)
        self.res2_3 = ResBlock(72)
        self.double_conv3 = DoubleConvLayer(in_channels=72, out_channels=144)
        self.res3_1 = ResBlock(144)
        self.res3_2 = ResBlock(144)
        self.res3_3 = ResBlock(144)
